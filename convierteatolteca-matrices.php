...
<?php
    ...
    */ 
	...
	/* (2) Obtener el numeral del año X = (anioG + 3)base13 
    */ 
	$numeralAnio = ($anio + 3) % 13;


	/* (3) Obtener el Tipo de Año A = (añoG)base4
	*/
	$tipoDeAnio = ($anio) % 4;
	...
	*/
	...
	echo "Año convertido anahuatl: ".convierteTipoAnio($tipoDeAnio)."<br />";
